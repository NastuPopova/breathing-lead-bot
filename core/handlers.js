...
class Handlers {
    ...
    this.telegramBot.on('callback_query', async (ctx) => {
      ...
      if (callbackData === 'get_bonus') {
        ...
        try {
          ...
          // Отправляем интригующий тизер (НОВЫЙ МЕТОД)
  ...
  async sendIntriguingTeaser(ctx, bonus, analysisResult) {
    ...
    // Красивый заголовок с эмодзи-рамкой
