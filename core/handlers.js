...
class Handlers {
  ...
  // ОБНОВЛЕННЫЕ МЕТОДЫ с ссылками на основной бот
  ...
  async handleOrderStarter(ctx) {
    ...
    message += `📖 *Подробнее о программе и отзывы* - в основном боте\n\n`;
  ...
  async handleOrderIndividual(ctx) {
    ...
    message += `📖 *Подробнее о консультациях и отзывы* - в основном боте\n\n`;
  ...
  async handleHelpChooseProgram(ctx) {
    ...
    message += `📖 *Детальное сравнение программ* - в основном боте\n\n`;
